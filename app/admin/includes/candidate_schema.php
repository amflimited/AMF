...
function ensure_candidate_tables() {
    ...
    db()->exec("CREATE TABLE IF NOT EXISTS source_promotion_checklists (
        ...
        source_type_known BOOLEAN NOT NULL DEFAULT FALSE,
        namecheap_compatibility_decided BOOLEAN NOT NULL DEFAULT FALSE,
        compliance_reviewed BOOLEAN NOT NULL DEFAULT FALSE,
        storage_estimate_completed BOOLEAN NOT NULL DEFAULT FALSE,
        field_mapping_drafted BOOLEAN NOT NULL DEFAULT FALSE,
        dedupe_profile_completed BOOLEAN NOT NULL DEFAULT FALSE,
        parser_assigned BOOLEAN NOT NULL DEFAULT FALSE,
        sample_run_possible BOOLEAN NOT NULL DEFAULT FALSE,

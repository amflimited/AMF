...
echo '<section class="card"><h2>Deployment</h2><p>GitHub webhook deploys should update this site immediately after a push to cpanel-deploy.</p><p><a href="'.h(admin_url('pages/deploy-status.php')).'">Open Deploy Status</a></p></section>';
